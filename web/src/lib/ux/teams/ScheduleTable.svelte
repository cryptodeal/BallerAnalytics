...
<div class="my-2 mx-auto bg-white backdrop-filter backdrop-blur-lg bg-opacity-40 text-black">
			...
			>
				<table class="min-w-full">
					<thead>
						<tr>
							<th
								class="px-6 py-3 text-base font-medium leading-4 tracking-wider text-left uppercase border-b border-gray-200"
							>
								Date/Time (ET)
							</th>
							<th
										...
										<div class="flex items-center">
											<div class="flex-shrink-0 w-10 h-10 mr-2">
												<img
													...
													alt="{visitor.team.infoCommon.name} logo"
												/>
											</div>
											<div class="text-sm leading-5">
												vs {visitor.team.infoCommon.name}
											</div>
										</div>
									{:else}
										<div class="flex items-center">
											...
											<div class="text-sm leading-5">
												...
												<span
													>{home.stats.totals.points > visitor.stats.totals.points
														? `${home.stats.totals.points}-${visitor.stats.totals.points}`
														: `${visitor.stats.totals.points}-${home.stats.totals.points}`}</span
												>
											</div>
										</td>
