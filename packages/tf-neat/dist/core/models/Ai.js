...
export class Ai {
    ...
    start(useImageRecognition, neuralNetworks) {
        ...
        for (let i = 0; i < this._totalGames; i++) {
            ...
            this._games[i].interval = setInterval(this.checkGame.bind(null, this, this._games, this._games[i]), 50);
        }
    }
    checkGame(ai, games, game) {
        if (game.genomeApi.isOver()) {
            ...
            ai._gamesRunning--;
            document.querySelector('_round-progress').style.width =
