import { colors } from '../Actor_Critic_Exp/const';
import type { Actor_Critic_Agent } from '../Actor_Critic_Exp/AC_Agent';
...
export class Env {
	...
	public initGrid(w = 6, h = 6) {
		...
		if (this.canvas) this.canvas.style.backgroundColor = 'rgb(0,0,0)';
	}
